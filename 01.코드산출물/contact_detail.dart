...
class _ContactDetailPage extends State<ContactDetailPage> {
  ...
  // 입력폼 컨트롤러
  final TextEditingController _memoInsertTitleController =
      TextEditingController();
  final TextEditingController _memoInsertContentController =
      TextEditingController();
  ...
  void _showMemoInsertDialog(BuildContext context) {
    // 컨트롤러 초기화
    _memoInsertTitleController.clear();
    _memoInsertContentController.clear();
      ...
      builder:
          (context) => AlertDialog(
            ...
            content: Column(
              ...
              children: [
                TextFormField(
                  controller: _memoInsertTitleController,
                  decoration: InputDecoration(
                    labelText: "제목",
                    border: OutlineInputBorder(),
                  ),
                ...
                SizedBox(height: 10),
                TextFormField(
                  controller: _memoInsertContentController,
                  maxLines: 5,
                  decoration: InputDecoration(
                    labelText: "내용",
                    border: OutlineInputBorder(),
              ...
              TextButton(
                ...
                onPressed: () async {
                  MemoController.addMemo(
                    _memoInsertTitleController.text,
                    _memoInsertContentController.text,
                    widget.contact.userId,
                  );
                  Navigator.pop(context);
                },
